...
| ---------------- | --------- | ----------------------------------------------------- |
| >**4.0.0** (LTS) | Yes       | Active support for security vulnerabilities.          |
| < 4.0.0          | ❌ No     | Please upgrade to the latest LTS version immediately. |
...
1. **Verify:** Ensure the vulnerability is reproducible on a clean install of version >**4.0.0**.
